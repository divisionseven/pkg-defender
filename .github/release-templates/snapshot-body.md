...
<h1>Threat Intelligence Snapshot — Latest</h1>
...
*This release was automatically generated by the PKG-Defender Snapshot workflow (`.github/workflows/snapshot.yml`). For questions or feedback, please [open an issue](https://github.com/divisionseven/pkg-defender/issues).*
